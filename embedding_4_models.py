...
def train_and_evaluate(data_name, nodes_list, embedding, name, graph_train, examples_train, labels_train, examples_model_selection, labels_model_selection, examples_test, labels_test, num_ones, walk_length = 5, batch_size = 50, epochs = 10):
    ...
    # emb_file = 'pickles/generated_embeddings/' + data_name + '_' + name + 'ones=' + num_ones + '_only_adj.pickle'
    # emb_file = 'pickles/generated_embeddings/{}_{}_ones={}_only_adj.pickle'.format(data_name, name, num_ones)
    with open('pickles/generated_embeddings/{}_{}_ones={}_only_adj.pickle'.format(data_name, name, num_ones), 'wb') as handle: pickle.dump(embDf, handle, protocol=pickle.HIGHEST_PROTOCOL)
    print(embDf)
...
# ===========================================================================================
def run(embedding, data_name, nodes_list, graph, rand_state, num_ones, walk_length=5, epochs=10, batch_size=50):
    ...
    if embedding == 'Node2Vec':
        ...
        result = train_and_evaluate(data_name, nodes_list, node2vec_embedding, "Node2Vec", graph_train, examples_train, labels_train, examples_model_selection, labels_model_selection, examples_test, labels_test, num_ones, walk_length, batch_size, epochs)
        print("############ -- Done node2vec results -- ###############")

    elif embedding == 'Attri2Vec':
        # Get Attri2Vec link prediction result
        print("############ -- Getting attri2vec results -- ###############")
        result = train_and_evaluate(data_name, nodes_list, attri2vec_embedding, "Attri2Vec", graph_train, examples_train, labels_train, examples_model_selection, labels_model_selection, examples_test, labels_test, num_ones, walk_length, batch_size, epochs)
        print("############ -- Done attri2vec results -- ###############")

    elif embedding == 'GraphSAGE':
        # Get GraphSAGE link prediction result
        print("############ -- Getting GraphSage results -- ###############")
        result = train_and_evaluate(data_name, nodes_list, graphsage_embedding, "GraphSAGE", graph_train, examples_train, labels_train, examples_model_selection, labels_model_selection, examples_test, labels_test, num_ones, walk_length, batch_size, epochs)
        print("############ -- Done GraphSage results -- ###############")

    elif embedding == 'GCN':
        # Get GCN link prediction result
        print("############ -- Getting GCN results -- ###############")
        result = train_and_evaluate(data_name, nodes_list, gcn_embedding, "GCN", graph_train, examples_train, labels_train, examples_model_selection, labels_model_selection, examples_test, labels_test, num_ones, walk_length, batch_size, epochs)
    ...
    print(df)
    print("Done calculating node2vec, attri2vec, graphsage, gcn results for " + data_name + " with random state " + str(rand_state))
    return df
# ===========================================================================================
